...
#### 0.31.2
 - 2018-09-13 - [1 commit](https://github.com/jaegertracing/jaeger-client-java/compare/v0.31.1...v0.31.2) by [Juraci Paixão Kröhling](https://github.com/jpkrohling) - published to [![Bintray](https://img.shields.io/badge/Bintray-0.31.2-green.svg)](https://bintray.com/jaegertracing/jaeger-client-java/maven/0.31.2)
